...
public abstract class JdbcRepository<T, ID extends Serializable>
    ...
    public void delete(T entity) {
        jdbcOperations.update(sqlGenerator.deleteById(table), idToObjectArray(getIdFromEntity(entity)));
    }
    ...
    public <S extends T> S save(S entity) {
        return ((entity instanceof Persistable && ((Persistable)entity).isNew()) || (getIdFromEntity(entity) == null)) ?
    ...
    public <S extends T> S create(S entity) {
        ...
        return getIdFromEntity(entity) == null
    ...
    private ID getIdFromEntity(T entity) {
        if (entity instanceof Persistable) {
            return ((Persistable<ID>)entity).getId();
        } else {
            ReflectionEntityInformation<T, ID> inf = new ReflectionEntityInformation<T, ID>((Class<T>)entity.getClass());
            return inf.getId(entity);
        }
    }
